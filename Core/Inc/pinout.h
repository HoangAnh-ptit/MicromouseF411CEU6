...
/* ============================================================================ */
/* IR DISTANCE SENSORS (6 RX + 6 TX) - CLUSTER LIEN MACH          */
/* ============================================================================ */

/* --- IR RECEIVERS (ADC1 Inputs) - Cum ADC lien mach 6 chan --- */
...
/* --- IR EMITTERS (GPIO Output) - Sap xep lien mach GPIO --- */
...
/* Helper cho Buzzer/Fan (Ghi vao thanh ghi CCR4 cua TIM2) */
